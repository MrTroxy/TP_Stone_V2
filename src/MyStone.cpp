...
datasRead  MyStone::getValidsDatasIfExists() {
    ...
    swap(shortData.shortDataCommand.c.c2, shortData.shortDataCommand.c.c1);
    swap(shortData.shortDataLongeur.c.c2, shortData.shortDataLongeur.c.c1);
...
int MyStone::writeIt(string cmdFormat2){
